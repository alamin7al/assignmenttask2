            ...
            <div className="">
                <Table className='' striped bordered hover>
                    <thead className=' tablebig '>
                        ...
                        <tr>
                            <th scope="col" className='fs-5 p-2  fw-normal'>হাসপাতালের নাম</th>
                            <th scope="col" className='fs-5 p-2  fw-normal'>সাধারণ</th>
                            <th scope="col" className='fs-5 p-2  fw-normal'>আইসিইউ</th>
                            <th scope="col" className='fs-5 p-2  fw-normal'>   অবস্থান    </th>
                            <th scope="col" className='fs-5 p-2  fw-normal'>   পুরো ঠিকানা    </th>
                            <th scope="col" className='fs-5 p-2  fw-normal'>   সর্বশেষ সংষ্করণ    </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
